        ...
        <div className='mx-auto py-24 max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 flex flex-col justify-center items-center'>
            ...
            <div className='flex flex-col  w-full'>
                ...
                {pricingType == 'design' && <div className='w-full gap-16 flex flex-col justify-between items-center mt-12 lg:flex-row'>
                    ...
                    />
                    <PricingCard isMain={true} type='UI/UX Design' desc='Clean and aesthetic UI with smooth user-friendly UX.' price={1900}
                ...
                {pricingType == 'development' && <div className='w-full gap-16 flex flex-col justify-between items-center mt-12 lg:flex-row'>
                    <PricingCard isMain={true} type='Landing Page' desc={`Create a swift, high-performing, and modern website to elevate your enterprise's professional image.`} price={3400}
                    ...
                    />
                    <PricingCard isMain={false} type='Full-Stack Project' desc='Integrate both frontend and backend technologies seamlessly in a database-driven, complex project.' price={7000}
